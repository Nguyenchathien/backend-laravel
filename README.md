...
`laravel-backend` is administrative interface builder for laravel which can help you build CRUD backends just with few lines of code.

Screenshots
------------

![laravel-backend](https://cloud.githubusercontent.com/assets/1479100/19625297/3b3deb64-9947-11e6-807c-cffa999004be.jpg)
...
```
Laravel 5.2
composer require encore/laravel-backend "dev-master"

Laravel 5.3
composer require encore/laravel-backend "1.3.x-dev"

Laravel 5.1
composer require encore/laravel-backend "1.1.x-dev"
```
...
```
php artisan vendor:publish --tag=laravel-backend
...
Other
------------
`laravel-backend` based on thses plugins or services:
...
License
------------
`laravel-backend` is licensed under [The MIT License (MIT)](LICENSE).
